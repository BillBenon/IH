...
import sdmCore from '../assets/track-icon/icon-interview-sdm-core.svg'
...
const TILES = [
    ...
    },
    {
        ...
        icon: code,
        text: "CODING",
        subtext: "Unlock your potential to think and code faster."
    }
];

const interviewSDMFaq = [
    {
...
const data = {
    ...
    faq: interviewSDMFaq,
    faqSubHeading: "Watch how our SDM mock interviews are conducted."
}
    ...
    return (
        <Fragment>
            ...
            <Button
                ...
                href="https://calendly.com/rsalota1/mock-interviews-paid-marketing"
            >
                Register
        </Button>

            <h4 className="track-type-description"><span>The Software Development Manager (SDM) track includes four topics you can choose from when scheduling a mock interview:</span></h4>
            ...
            <InterviewFaq faq={interviewSDMFaq} data={data} />
        </Fragment>
    )
}
