...
const data = {
    price: 300,
    video: "https://player.vimeo.com/video/410794982",
    faq: interviewSDEFaq,
    faqSubHeading: "Watch how our SDE mock interviews are conducted."
}
...
function InterviewHeader({ classes, icon, text, subtext }) {
    return (
        <Fragment>
            ...
            <h4 className="track-type-description"><span>The Software Development Engineer (SDE) track includes three topics you can choose
        from when scheduling a mock interview:</span></h4>
            ...
            <InterviewFaq faq={interviewSDEFaq} data={data} />
        </Fragment>
    )
}
