...
import { Button, DnDWrapper, FileNameWrapper, Font14, Font18, ImageWrapper, UploadWrapper } from './ImageUploadStyled';
...
const ImageUpload = ({ onFileUpload, url, error, isLoading, fileInputRef, expertId }: Props) => {
          ...
          <UploadWrapper className="d-flex w-100 justify-content-center">
            <div>
              ...
              <div className="d-flex align-items-center justify-content-center">
                <Button
                  theme={{ color: ((!error && !fileUrl) || file) ? 'rgba(0, 0, 0, 0.48)' : (!error ? '#16AB6B' : '#E25252') }}
                  disabled={!file} type="button"
                  className="d-flex"
